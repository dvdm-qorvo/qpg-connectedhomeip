...
* [Provision the QPG6100 sensor board using CHIPTool](#provision-the-qpg6100-sensor-board-using-chiptool)
...
* [Factory Reset](#factory-reset)
	* [QPG6100 sensor board factory reset](#qpg6100-sensor-board-factory-reset)
...
Connect the QPG6100 sensor board to a laptop.
...
You can [download a CHIPTool application build from this GitHub repository](./apk/app-debug-arm.apk), open it on an Android smartphone to install it.

![CHIPTool](./imgs/CHIPtool.png "https://github.com/Qorvo/qpg-connectedhomeip/examples/ot-br/")

## Provision the QPG6100 sensor board using CHIPTool

The QPG6100 DK provided with this kit ships ready to be commissioned. If you already commissioned the device, [perform a factory reset](#qpg6100-sensor-board-factory-reset) first.
...
You should now be able to operate the light application running on the QPG6100 sensor board using the controls.
...
### QPG6100 sensor board factory reset
...
![QPG6100 sensor board reset](./imgs/qpg6100_reset.png "QPG6100 sensor board reset")
...
The QPG7015M based border router build documentation can be found [in the Qorvo OpenThread repository](https://github.com/Qorvo/qpg-openthread).
